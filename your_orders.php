        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="iages/food-picky-logo.png" alt=""> </a>
							...
							?>
												<tr>	
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price"><?php echo "₹".$to += ($row["price"]*$row["quantity"]);?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-success"><span class="fa fa-cog fa-book" style="font-weight:bold;">Order placed</button>
																		   <?php 
																			  }
